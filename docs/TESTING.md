...
Verified live URL: https://research-devices-webmcp-demo.vercel.app/ (repository and Native WebMCP checks completed 2026-08-30T05:39:50.359Z). For deterministic local verification, the loopback workflow below remains available.
